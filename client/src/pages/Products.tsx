            ...
            <div key={product.id} className="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition">
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between mb-4">
                  <span className="text-xl font-bold text-[#000000]">₹{product.price}</span>
                ...
                <button
                  ...
                  className="w-full bg-[#51CF66] hover:bg-[#47b85a] disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-semibold py-2.5 rounded-lg transition"
                >
